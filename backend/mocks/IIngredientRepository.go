...
// IIngredientRepository is an autogenerated mock type for the IIngredientRepository type
type IIngredientRepository struct {
	mock.Mock
}

// Create provides a mock function with given fields: ctx, ingredient
func (_m *IIngredientRepository) Create(ctx context.Context, ingredient *domain.Ingredient) error {
...
func (_m *IIngredientRepository) DeleteById(ctx context.Context, id uuid.UUID) error {
...
func (_m *IIngredientRepository) GetAll(ctx context.Context, page int) ([]*domain.Ingredient, int, error) {
...
func (_m *IIngredientRepository) GetAllByRecipeId(ctx context.Context, id uuid.UUID) ([]*domain.Ingredient, error) {
	ret := _m.Called(ctx, id)
...
func (_m *IIngredientRepository) GetById(ctx context.Context, id uuid.UUID) (*domain.Ingredient, error) {
	ret := _m.Called(ctx, id)
...
func (_m *IIngredientRepository) Link(ctx context.Context, recipeId uuid.UUID, ingredientId uuid.UUID) (uuid.UUID, error) {
...
func (_m *IIngredientRepository) Unlink(ctx context.Context, recipeId uuid.UUID, ingredientId uuid.UUID) error {
	ret := _m.Called(ctx, recipeId, ingredientId)
...
// Update provides a mock function with given fields: ctx, ingredient
func (_m *IIngredientRepository) Update(ctx context.Context, ingredient *domain.Ingredient) error {
	ret := _m.Called(ctx, ingredient)
...
// NewIIngredientRepository creates a new instance of IIngredientRepository. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewIIngredientRepository(t interface {
	mock.TestingT
	Cleanup(func())
}) *IIngredientRepository {
	mock := &IIngredientRepository{}
	mock.Mock.Test(t)
