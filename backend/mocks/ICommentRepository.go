...
func (_m *ICommentRepository) Create(ctx context.Context, comment *domain.Comment) error {
...
func (_m *ICommentRepository) DeleteById(ctx context.Context, id uuid.UUID) error {
...
func (_m *ICommentRepository) GetAllBySaladID(ctx context.Context, saladId uuid.UUID, page int) ([]*domain.Comment, int, error) {
...
func (_m *ICommentRepository) GetById(ctx context.Context, id uuid.UUID) (*domain.Comment, error) {
	ret := _m.Called(ctx, id)
...
func (_m *ICommentRepository) GetBySaladAndUser(ctx context.Context, saladId uuid.UUID, userId uuid.UUID) (*domain.Comment, error) {
...
func (_m *ICommentRepository) Update(ctx context.Context, comment *domain.Comment) error {
	ret := _m.Called(ctx, comment)
